            ...
            <div id="mcqContainer" class="space-y-6">
                ...
                if (have_posts()) :
                    ...
                    while (have_posts()) : the_post();
                        // Only show MCQ cards for MCQ post type
                        if (get_post_type() === 'mcqs') :
                            // Get MCQ meta fields
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mb-6">There are no quiz questions available in this category.</p>
